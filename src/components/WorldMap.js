...
class WorldMap extends Component {
   ...
   findColor(country_name) {
      const info_dict = testerdata["countries"][country_name]
   ...
   render() {
      ...
      const real_data = testerdata['countries']
      ...
      return (
         <WorldMapStyle>
               <svg className="world-map" height="100%" width="100%" viewBox={"30 0 930 600"}>
               {countries}
                  <svg width="1000" height="500">
                     <defs>
                        <linearGradient x1="100%" y1="50%" x2="0%" y2="50%" id="mapLegend1">
                           <stop stop-color="#000000" offset="0%"></stop>
                           <stop stop-color="#FFF977" offset="83.5884713%"></stop>
                           <stop stop-color="#FFFFFF" offset="100%"></stop>
                        </linearGradient>
                        <linearGradient id="mapLegend2" x1="100%" y1="50%" x2="0%" y2="50%">
                           <stop stop-color="#AA0000" offset="0%"></stop>
                           <stop stop-color="#E28105" offset="50%"></stop>
                           <stop stop-color="#FCEB6D" offset="100%"></stop>
                        </linearGradient>
                     </defs>
                     <g id="legend" >
